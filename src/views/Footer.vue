    ...
    <v-container>
        <v-footer padless>
            <v-card flat tile class="white lighten-1 text-center">
                ...
                <v-card-text>
                    In no event shall any part or all of the images be reproduced, transmitted, distributed or altered without official permission.
                    Violation of the above may result in legal punishment.
                </v-card-text>
